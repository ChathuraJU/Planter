<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Roboto:400,300,100,500,700,900" rel="stylesheet"
          type="text/css">
    <link href="{{ asset('global_assets/css/icons/fontawesome/styles.min.css') }}" rel="stylesheet"
          type="text/css">
    ...
    <script src="{{ asset('global_assets/js/core/libraries/jquery_ui/effects.min.js ') }}"></script>
    <script src="{{ asset('global_assets/js/plugins/notifications/sweet_alert.min.js') }} "></script>
    <script src="{{ asset('global_assets/js/plugins/notifications/noty.min.js') }} "></script>
    <script src="{{ asset('global_assets/js/plugins/forms/selects/bootstrap_select.min.js') }} "></script>
...
<form class="hidden" action="{{ url('logout') }}" method="POST" id="frmLogout">
        ...
        <ul class="nav navbar-nav navbar-right" style="color: #5a6268">
            ...
            <li class="dropdown dropdown-user">
                <a class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span> {{ auth()->user()->person->fname }}</span>
                    <i class="caret"></i>
                </a>
...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <!-- Main sidebar -->
        <div class="sidebar sidebar-main sidebar-fixed cju-sidebar">
            <div class="sidebar-content">
                ...
                <div class="sidebar-user">
                    <div class="category-content">
                        <div class="media">
                            <a href="#" class="media-left"><img src="{{ asset('images/users/1.jpg') }}"
                                                                class="img-circle img-sm" alt=""></a>
                            <div class="media-body">
                                <span class="media-heading text-semibold">{{ auth()->user()->person->fname }} {{ auth()->user()->person->lname }}</span>
                                <div class="text-size-mini text-muted">
                                    <i class="text-size-small">EPF No : {{ auth()->user()->person->epf }}</i>
                                </div>
                            </div>
